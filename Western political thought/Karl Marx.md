...
- in order to think, one has to eat and in order to eat, man has to rpoduce. thus production is the first historical act of man rather than thinking. Hence demonstrating that manual labour is superior to mental labour since production comes prior to thinking
...
- the class which controls the basic structure(means of prodn) controls the instituions of super structure.
...
1. Pre historic  
   - no pvt property  
   - primitive communism  
   - no class struggle so no state needed  

2. Slave society  
   - master and slave  
   - since class exist so class struggle exists and hence state needed to protect the masters  
...
5. Socialism( dictatorship of proletariat)  
   - stage immediately after revolution  
   - workers(exploiters) and capitalists(exploited)  
   - so state exists but controlled by workers  

6. Communism( end of history)  
   - pvt property abolished  
   - no class and hence no class struggle  
   - end of history  
   - state of perfect freedom due to state of perfect equality  
...
- capitalism destroys human essence and hence communism becomes a necessity.

## Marx's critics:

### Non marxists:

1. Karl popper calls marx as reductionist and determinist and his theory as unscientific as it is not open to falsification. Acc to popper, scientific theories are possible only in open societies like democracy and not communist societies that are closed. Says Marx has committed the guilt of historicism  

2. Max Weber- monocausal explaination of history  

### By marxists:

1. Gramsci- Marx underestimated role of superstructure specially of culture.  
...
- That Marx still looms so large in our present world is indeed the measure of his greatness."-Hannah Arendt