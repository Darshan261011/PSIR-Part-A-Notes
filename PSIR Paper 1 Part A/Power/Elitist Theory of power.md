...
- They represent procedural aspect of democracy.  
- Understand democracy as elections Believe that elections is Max function masses can perform.  
- More than that neither needed nor desired.  

- Take a balanced position between monistic theory of power which says state is the sole authority of power and pluralistic theory of power that says power is distributed amongst various pressure groups.  
...
- elite theory recognizes that "counter-elites" frequently develop within such excluded groups.  

- Negotiations between such disenfranchised groups and the state can be analyzed as negotiations between elites and counter-elites.  

- A major problem, in turn, is the ability of elites to co-opt counter-elites.  
...
- In criticism of elitist theory of power by CW Mills that says power only lies with elites.  

- Dahl criticises Mills and says in USA power does not lie with power elites but with pressure groups.  

- Exponents- robert dahl  

## Robert Dahl’s survey in his work -Polyarchy: participation and opposition.

1. his survey found that people in usa were fairly enjoying power but not as individuals but association.  

2. acc to dahl, usa is neither oligarchy nor democracy, but polyarchy. Power is dispersed into numerous interest groups.  

3. For them if democracy is the rule of all, then polyarchy is the rule of many.  

4. Democracy is ideal. Polyarchy is the functional form of democracy.  

5. Polyarchies have helped to keep arbitrary powers of govt in check and made politics participative and representative.  

6. concept of deformed polyarchies(neo-pluralism): dahl and lindblom.  
- Dahl accepted that not all groups enjoy equal power , polyarchy tilted in favour of corporate groups.  
- This is akin to relative autonomy theory of state by structural marxists who say in crisis the state is more inclined towards the capitalist class( nicos poulantzas)