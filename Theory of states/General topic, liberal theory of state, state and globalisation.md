...
## Sovereignity:
- defined by Jean Bodin “ supreme power over citizens and subjects, unrestrained by law.”

## Theories of sovereignity-
...
- Monistic theory emerged to address the chaos in the medieval age. Pluralistic theory emerged to avoid recurrance of war(as it puts limits on state sovereignity)

#### exponents:

##### Harold laski
- when society is federal, authority should also be fedreal.
...
- He argues that allegiance to various associatoins are partial and proportional to their contribution.
...
- gives Concept of service state ie state has been formed to serve the people.
...
- For moderate pluralists state is an institution of social architecture ie though many institutions exist but state is the most important. It is the state that keeps society together and hence enjoys primacy over other institutions
...
- they want to keep the state to avoid anarchy but also limit its power. But state automatically assumes primacy due to unique role that it performs. Henxe they want to keep the cake and have it too.

- more realistic and relevant in present times as there is a cry for more and more decentralisation and diffusion of power.
...
- Thomas Friedman: Book : The Lexus and the olive tree:globalisation is the inexorable integration of markets, nations states, technology to an extent never seen before . Interactions have become Farther, Faster Cheaper, deeper .

### Context:
- Origin of state under social contract as given by Hobbes and Locke
- State is a historical institution whose forms have been changing ( McIver’s evolutionary theory of state)
...
- acc to them there is a considerable decline in the powers of the state bcoz of globalisation.

- From billards ball model, the world has moved towards cobweb model.
...
- MNCs challenging the sovereignty of state. ( recent controversy of IT rules , Indian govt vs Whatsapp)
...
- Globalisation has brought threats like trans national terrorism , organised crime because of which state has considerably expanded its powers.

- We are witnessing what Jayant Sinha and Samir Saran call “gated globalisation” wherein state is allowing limited connection with the world.

- After 9/11 and 2008 financial crisis, Brexit and election of Donald trump, there has been a marked shift towards deglobalisation further accentuated by COVID19.

- Now states are talking about resilient supply chains to reduce dependencies on foreign countries that has occurred because of globalisation and the WTO’s policies based on “comparative advantage” theory.

## In conclusion-

- Vinod Rai in his book rethinking good governance says - regardless of the extent of globalisation and effect on sovereignity, the distinguishing factor is always how well the state is administered.

## Liberal theory of state

1. state comes from a social contract  
2. limited state  
3. state cannot be forced on man  
...
### Catherine mackinnon(a radical feminist)
...
- J w Garner had rightly said that- political science begins and ends with state