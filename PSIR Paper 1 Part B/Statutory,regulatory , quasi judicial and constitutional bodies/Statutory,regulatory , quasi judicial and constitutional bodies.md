...
- [NCW](#ncw)
  ...
  - [Functions](#functions)
  - [Drawback](#drawback)
- [NC minorities](#nc-minorities)
  - [Way ahead](#way-ahead-nc-minorities)
  - [Conclusion](#conclusion-nc-minorities)
- [Ncst](#ncst)
  - [Issues](#issues-ncst)
  - [Pesa](#pesa)
  - [Fra](#fra)
  - [Xaxa committees](#xaxa-committees)
- [CAG](#cag)
  - [Credits](#credits)
  - [Issues](#issues-cag)
  - [way ahead](#way-ahead-cag)
  - [conclusion](#conclusion-cag)
- [Election commission](#election-commission)
  - [Advisory jurisdiction](#advisory-jurisdiction)
  - [quasi judicial function](#quasi-judicial-function)
  - [Administrative functions](#administrative-functions)
  - [issues in electoral process](#issues-in-electoral-process)
  - [challenges](#challenges)
  - [reforms](#reforms)
  - [conclusion](#conclusion-eci)
- [Nhrc](#nhrc)
  - [Issues](#issues-nhrc)
  - [Suggestions](#suggestions)
  - [Initiatives](#initiatives)
  - [Actions taken](#actions-taken)
  - [conclusion](#conclusion-nhrc)
- [Ncsc](#ncsc)
- [Ncbc](#ncbc)
...
### DPSP
- 39A,39D(equal pay for equal work for men and women), 42(maternity leave)  
- Reservation in PRI,ULB  
...
### Functions
- Mandate under NCW Act 6  
- under sec 10(1)  
1. Safeguard of rights of women granted by the constitution & laws  
2. Study the problems faced by women and come out with recommendations to eradicate these problems  
3. Evaluating the working of women  
4. Funding litigation cases related to women’s rights violations  

- Function:  
- To counsel victims in person  
- To take part in planning processes related to socio economic dev of women  
- enjoys authority of a civil court  
- Accomplishments  
- complaint & counselling cell of the commn is the most successful organ of the org  
- commn was successful in securing the release of female alleged gangraped by BSF personnel  
- Legal cell of the commn has recommended modifications to Hindu marriage act  

---

### Drawback
- Dependent on union for funds and funcationaries hence hesitant to criticise union govt  
- At best it Protects women but not empowers them  
- Means to distribute political patronage  
- Struggle between member secy and chairperson  
- recommendations are not mandatory.  
- Sadhna arya- centre for women development studies- members lack transformational ideology and not proactive.  
- NCW head accused women of crying rape to settle property disputes and claim compensation. Also NCW head had suggested that women being called “sexy” should take it as a compliment.  
- pam rajput comm: NCW must go beyond reactive instruments to fulfil the proactive mandate of studying,influencing policies,laws to ensure full benefits to women  
- Funds to be charged on CFI so as to make the body independent  
- All members of NCW are women based on the ideology of radical feminism that only women can understand problems of women, which today is not true.  
- BR Ambedkar- I measure the progress of a community with the progress of its female members. NCW can help in realising the ideals of feminism that advocates eliminating patriarchy and equality between men and women in all spheres of life.  
...
### Conclusion (NC minorities)
- Follow sabka sath sabka vikas sabka vishwas approach  

---

## Ncst
- 89AA added article 338A  
...
### Fra
- Individual community or community property rights  
- jal jangal jameen  
1. Land title rights  
2. Use rights  
3. Relief & development  
4. Forest mgmt rights  
...
### conclusion (CAG)
- PM Modi- CAG is a heritage and every generation must cherish it.  

---

## Election commission
- art 324 to 329  
- Sy quereshi- book- undocumented wonder- India is known for three things in the world, Gandhi,taj Mahal, and elections. He says “democracy and elections have a congenital, inseparable relationship.”  

---

### Advisory jurisdiction
- Advices Prez and Governor regarding disqualification  
- Advices prez on conducting elections during president’s rule in a state  

---

### quasi judicial function
- Settling election disputes  
- Incase of a split, recognising the legitimate faction and Allocating symbols to them  
- Disqualify candidates failing to lodge election expenses in due time  
- Powers to reduce disqualification of a candidate  
- Deciding matters related to violations of model code of conduct  
...
- Increasing role of money power  
- 60000 cr spent in Lok Sabha 2019, second only to US 2020 elections  
- Electoral bonds outside RTI and IT act  
- 3Ms money muscle and media  
- Recent amendment to FCRA act has relaxed the definition of foreign companies allowing Indian subsidiaries of foreign companies to be treated as exempted from FCRA  

---

### challenges
- Budget is not charged- Law ministry sanctions the budget  
- Frequent violations of mcc  
- Question mark on evm and vvpat after every election  
- Pranab Mukherjee had to remind eci to maintain institutional integrity during 2019 elections  
- 66 former bureaucrats had written to president to ensure EC's neutrality  
- Allowing campaign in WB amidst second wave  
- Recently the CEC and 2 ECs were called for a meeting by the PMO. Such instances lead to speculation about EC’s neutrality  
- Inadequate staff  
- Not a dedicated cadre of bureaucracy as officers are sent on deputation to ECI.  

---

### reforms
- Constitutional proteciton of tenure to EC as is given to CEC  
- Reducing EC’s dependence on law ministry,home ministry and DOPT for human and material resources  
- expenditures must be charged and not voted upon the CFI to ensure independence of ECI  
- MCC to have legal backing - Dinesh goswami committee and NCRWC  
- Collegium system to appoint CEC and EC - NCRWC  
- Political parties must maintain accounts of receipt of funds and expenditure in a systematic and regular manner – NCRWC  
- ECI is also demanding a new section 58B in RPA, 1951 to deal with money menace similar to section 58A which is related to booth capturing  
- EC must also be given powers to deregister a political party  
- 2nd ARC also recommends constitution of Special Elections Tribunal for speedy disposal of election petitions and disputes  
- Indrajit Gupta comm- partial state funding of elections  

---

### conclusion (ECI)
- An independent Eci is a gift of the constitution to the nation. If India is known for it's democracy,credit goes to ECI to a large extent.  
...
### conclusion (NHRC)
- Nonetheless NHRC has played a key role in developing a culture of human rights in india. To deny people their human rights is to challenge their very humanity. — Nelson Mandela  
...
## NITI Aayog
- Niti Aayog is like a funnel, that takes ideas from experts, civil society, academicians and transfers it as an input in the system and follows up on it- Niti Aayog VC Rajeev kumar  
